                        ...
                        {rJson?.length > 0 && rJson?.map((value,index)=>{ 
                            return <div className="card d-flex justify-content-start flex-row flex-wrap shadow" style={{borderTopLeftRadius: '2.0rem', borderBottomRightRadius: '1.5rem'}} key={index}>
                                ...
                                <div className="flex justify-between">
                                    <button onClick={()=>{location.href=`/tour/${value.idTourPkg}`}} className="w-fit d-none d-xl-flex justify-content-center rounded-2 border-none fw-bold text-black px-9 py-2" style={{backgroundColor: 'transparent', fontFamily: 'Montserrat', border:"2px solid #2158AA"}}>
                                        VIEW DETAILS
                                    </button>
                            ...
                            <button onClick={()=>{location.href=`/tour/${value.idTourPkg}`}} className="w-fit d-flex d-xl-none justify-content-center border-none fw-bold text-black col-12 px-9 py-2" style={{backgroundColor: 'transparent', fontFamily: 'Montserrat', borderRadius: '0px 0px 20px 0px', border:"2px solid #2158AA"}}>
                                VIEW DETAILS
                            </button>
                            </div>
                        })}
