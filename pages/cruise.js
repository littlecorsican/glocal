                    ...
                    <div className="web-cards">
                        ...
                        {rJson?.length > 0 && rJson?.map((value,index)=>{ 
                            return <div className="card d-flex justify-content-start flex-row flex-wrap shadow" style={{borderTopLeftRadius: '2.0rem', borderBottomRightRadius: '1.5rem'}} key={index}>
                                ...
                                <button onClick={()=>{location.href=`/cruise/${value.idTourPkg}`}} className="btn d-none d-xl-flex justify-content-center p-2 rounded-5 border-none fw-bold text-white" style={{backgroundColor: '#b8b09d', fontFamily: 'Montserrat', maxWidth: '445px'}}>
                                    VIEW DETAILS | From RM { value.price }
                                </button>
                                </div>
                                <button onClick={()=>{location.href=`/cruise/${value.idTourPkg}`}} className="btn d-flex d-xl-none justify-content-center p-2 border-none fw-bold text-white col-12" style={{backgroundColor: '#b8b09d', fontFamily: 'Montserrat', borderRadius: '0px 0px 20px 0px'}}>
                                VIEW DETAILS | From RM { value.price }
                                </button>
                            </div>
                            })}
