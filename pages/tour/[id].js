            ...
            <div className="web-package-details container py-5">
              <div className="row g-5 responsive-flex">
                ...
                <div className=" col-lg-7 col-12 order-2 order-lg-1 flex-1">
                    ...
                    <div className="flex">
                    <div className="flex-1 tab-header block text-[#fff] bg-colourblue text-center p-3 m-4 rounded" id="selectdates">
                      FULL TOUR  
                    </div>
                        ...
                        <tbody id="selectDate">
                          {tourDepList && tourDepList.map((value,index)=>{
                            return <tr key={index}>
                                ...
                                <td className="align-top"> 
                                <button className="rounded px-7 py-2 text-white bg-colourblue" onClick={()=>location.href=`/booking-tour?id=${value?.idBase}&idTourPkg=${value?.idTourPkg}`}>Departure Detail</button>
                              </td>
                              </tr>
                          })}
                        </tbody>
