                        ...
                        <tbody>
                          {rJson.tourDepList && rJson.tourDepList.map((value,index)=>{
                            return <tr key={index}>
                                ...
                                <td className="align-top"> 
                                  <button className="rounded px-7 py-2 text-white bg-[#b32129]" onClick={()=>location.href=`/booking-tour?id=${value?.idBase}&idTourPkg=${value?.idTourPkg}`}>Departure Detail</button>
                                </td>
                              </tr>
                          })}
                        </tbody>
