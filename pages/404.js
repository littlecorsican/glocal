        ...
        <>
            <div id="hero" style={{paddingTop: "282px", paddingBottom: "200px"}}>
                ...
                <div className="d-flex flex-column align-items-center">
                    <h1 className="error-title" style={{textAlign: "center", fontFamily: "Montserrat", fontWeight: "700", color: "#2158AA"}}>PAGE NOT FOUND</h1>
                ...
                <Link href="/" style={{textDecoration: 'none'}}>
                    <button className="d-md-block d-none" style={{border: 'none', paddingLeft: '45px', paddingRight: '45px', paddingTop: '15px', paddingBottom: '15px', backgroundColor: '#E8932A', color: '#fff', fontFamily: 'Montserrat', fontWeight: 700, fontSize: '18px', borderRadius: '100px'}}>Back HOMEPAGE</button>
                </Link>
                </div>
            </div>
        </>
