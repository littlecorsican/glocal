...
export default function Passenger(props) {
   ...
   const onChange=(e)=>{
      ...
      props.handleInputChange(props.roomId, props.travellerId, e.target.id, e.target.value, props.passengerList)
   }
   ...
   return (
      <div>
         <h3 style={{fontFamily: '"Montserrat"', fontStyle: 'normal', fontWeight: 700, fontSize: '19px', lineHeight: '23px', textTransform: 'uppercase', color: '#500000'}}>ROOM {props.roomId}</h3>

         <h5 style={{fontFamily: '"Montserrat"', fontStyle: 'normal', fontWeight: 700, fontSize: '19px', lineHeight: '23px', textTransform: 'uppercase', color: '#500000'}}>Traveller {props.travellerId}</h5>
         ...
         <div className="d-flex flex-row flex-xl-nowrap flex-wrap justify-content-start input-column gap-2">
            ...
            <DropDownMenu title="Nationality" id="idCountry" onChange={onChange} data={tour_context?.country} textKey="countryName" valueKey="idCountry" />
