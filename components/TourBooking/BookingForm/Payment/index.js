...
export default function Summary(props) {
    ...
    const createPayment=()=>{
        ...
        const amount = tour_context?.selectedPaymentMode == payment_mode.pay_full_amount ? fnReturn.amountPostAdminCharges : fnReturn.depositAmount

        const merchantID = process.env.NEXT_PUBLIC_MERCHANT_ID
        const orderid = tour_context?.successfulBookingId
