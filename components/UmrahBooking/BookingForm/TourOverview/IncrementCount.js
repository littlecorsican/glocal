...
export default function IncrementCount(props) {
   ...
   return (
    <div className="d-flex flex-column">
        ...
        <div className="d-flex flex-row justify-content-between text-colourblue" style={{background: '#F5F5F5', width: '153px'}} >
          ...
          <p className="d-flex align-items-center justify-content-center m-0 w-100 children_p font-bold" id="children_1" style={{fontFamily: '"Montserrat"', border: '1px solid #CDCDCD'}}>{props.count}</p>
