...
export default function Summary(props) {
    ...
    const sendApi=async()=>{
        ...
        try {
            ...
            umrah_context?.setLoadingText("Registering customer details....")

            const fetch2Body = umrah_context.userInputData
            fetch2Body.idBooking = umrah_context.successfulBookingId
            ...
            <div id="order_info_table">
                ...
                <table className="m-0 w-100 overflow-scroll">
                    ...
                    <tr style={{borderBottom: '1px solid #e8e2d6'}}>
                        ...
                        <td style={{fontFamily: '"Poppins"', fontWeight: 600, fontSize: '16px'}} className="col-xl-9 col-5 p-3 fw-bold">
                            {umrah_context?.userInputData?.sexCd}
                        </td>
                    </tr>
                    <tr style={{borderBottom: '1px solid #e8e2d6'}}>
