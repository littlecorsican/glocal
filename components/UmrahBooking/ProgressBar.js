                    ...
                    if (props.index == index) {
                        return  <div key={index}>  
                            <div className="d-none d-xl-flex justify-content-center align-items-center flex-column">
                                ...
                                <p
                                    className="text-white fw-bold m-0 d-flex justify-content-center align-items-center"
                                    style={{ fontFamily: '"Montserrat"', width: 40, height: 40 }}
                                >
                                    {value.id}
                                </p>
                                </div>
                                <h6 className="fw-bold" style={{ color: "#EA242D" }}>
                                    {value.string}
                                </h6>
                            </div>
                            <div className="d-flex d-xl-none justify-content-start align-items-center flex-column col-3">
                                ...
                                <h6 className="fw-bold text-center" style={{ color: "#EA242D" }}>
                                    {value.string}
                                </h6>
                            </div>
                        </div>
                        ...
                        <div className="d-none d-xl-flex justify-content-center align-items-center flex-column">
                            ...
                            <h6 className="fw-bold" style={{ color: "#B8B09D" }}>
                                {value.string}
                            </h6>
                        </div>
                        <div className="d-flex d-xl-none justify-content-start align-items-center flex-column col-3">
                            ...
                            <h6 className="fw-bold text-center" style={{ color: "#B8B09D" }}>
                                {value.string}
                            </h6>
                        </div></div>
                    }
